#
#   TravCalc 3.0.6 Beta for Mongoose Traveller 2nd Edition
...
import time
from mainwindow_306b import Ui_MainWindow
from aboutdialog_306b import Ui_aboutDialog
...
__app__ = 'TravCalc 3.0.6 (Beta)'
__version__ = '3.0.6b'

#form_class = uic.loadUiType("mainwindow_306b.ui")[0]
...
#                         filemode = 'w')
    ...
    log = logging.getLogger('TravCalc306b')
